...
<head>
    ...
    <!-- GOOGLE FONTS                              -->
    <!-- ––––––––––––––––––––––––––––––––––––––––– -->
    <link href="{{url('https://fonts.googleapis.com/css?family=Montserrat:400,500,600')}}" rel="stylesheet">
    <link href="{{url('https://fonts.googleapis.com/css?family=El+Messiri:700')}}" rel="stylesheet">
    <!-- ––––––––––––––––––––––––––––––––––––––––– -->
    <!-- Include CSS Filess                        -->
    <!-- ––––––––––––––––––––––––––––––––––––––––– -->
    <!-- Bootstrap -->
    <link href="{{asset('assets\mywebsite\css\bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets\mywebsite\css\bootstrap-rtl.css')}}" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="{{asset('assets\mywebsite\vendors\font-awesome\css\font-awesome.min.css')}}" rel="stylesheet">
    <!-- Linearicons -->
    <link href="{{asset('assets\mywebsite\vendors\linearicons\css\linearicons.css')}}" rel="stylesheet">
    <!-- Owl Carousel -->
    <link href="{{asset('assets\mywebsite\vendors\owl-carousel\owl.carousel.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets\mywebsite\vendors\owl-carousel\owl.theme.min.css')}}" rel="stylesheet">
    <!-- Flex Slider -->
    <link href="{{asset('assets\mywebsite\vendors\flexslider\flexslider.css')}}" rel="stylesheet">
    <!-- Template Stylesheet -->
    <link href="{{asset('assets\mywebsite\css\base.css')}}" rel="stylesheet">
...
<noscript>
    <div class="noscript alert-error">
        For full functionality of this site it is necessary to enable JavaScript. Here are the <a href="#" target="_blank">instructions how to enable JavaScript in your web browser</a>.
    </div>
</noscript>
<!-- ––––––––––––––––––––––––––––––––––––––––– -->
<!-- PRELOADER                                 -->
...
<div id="pageWrapper" class="page-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <ul class="nav-top nav-top-right list-inline t-xs-center t-md-left">
                            <li>
                                <a href="#"><i class="fa fa-flag-ar"></i>العربية <i class="fa fa-caret-down"></i></a>
                                <ul>
                                    <li><a href="../index.html"><i class="fa fa-flag-en"></i>English</a>
                                    </li>
                                    <li><a href="index.html"><i class="fa fa-flag-ar"></i>العربية</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li><a href="signin.html"><i class="fa fa-lock"></i>تسجيل الدخول</a>
                            </li>
                            <li><a href="signup.html"><i class="fa fa-user"></i>حساب جديد</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row row-rl-0 row-tb-20 row-md-cell">
                    <div class="brand col-md-3 t-xs-center t-md-right valign-middle">
                        <a href="#" class="logo">
                            <img src="{{asset('assets\mywebsite\images\logo.png')}}" alt="" width="250">
                        </a>
                    </div>
                            ...
                            <div class="col-sm-8">
                                <form class="search-form">
                                    <div class="input-group">
                                        <input type="text" class="form-control input-lg search-input" placeholder="ادخل كلمة للبحث..." required="required">
            ...
            <div class="container">
                <nav class="nav-bar">
                    ...
                    <div id="header-navbar" class="nav-collapse">
                        <ul class="nav-menu">
                            ...
                            <li class="dropdown-mega-menu">
                                <a href="deals_grid.html">صفقات</a>
                                <div class="mega-menu">
                                    <div class="row row-v-10">
                                        <div class="col-md-3">
                                            <ul>
                                                <li><a href="deals_grid.html">عرض الشبكة</a>
                                                </li>
                                                <li><a href="deals_grid_sidebar.html">الشبكة مع الشريط الجانبي</a>
                                                </li>
                                                <li><a href="deals_list.html">عرض القائمة</a>
                                                </li>
                                                <li><a href="deal_single.html">صفقة واحدة</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-md-3">
                                            <figure class="deal-thumbnail embed-responsive embed-responsive-4by3" data-bg-img="{{asset('assets/mywebsite/images/deals/deal_03.jpg')}}">
                                                ...
                                                <div class="deal-about p-10 pos-a bottom-0 right-0">
                                                    ...
                                                    <h6 class="deal-title mb-10">
                                                        <a href="deal_single.html" class="color-lighter">هنالك العديد من الأنواع المتوفرة</a>
                                                    </h6>
                                                </div>
                                            </figure>
                                        </div>
                            ...
                            <li>
                                <a href="coupons_grid.html">كوبونات</a>
                                <ul>
                                    <li><a href="coupons_grid.html">شبكة عرض</a>
                                    </li>
                                    <li><a href="coupons_grid_sidebar.html">الشبكة مع الشريط الجانبي</a>
                                    </li>
                                    <li><a href="coupons_list.html">عرض القائمة</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="stores_01.html">متاجر</a>
                                <ul>
                                    <li><a href="stores_01.html">البحث عن متاجر</a>
                                    </li>
                                    <li><a href="stores_02.html">تصنيفات المتاحر</a>
                                    </li>
                                    <li><a href="store_single_01.html">المتجر الشكل 1</a>
                                    </li>
                                    <li><a href="store_single_02.html">المتجر الشكل 2</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="contact_us_01.html">اتصل بنا</a>
                                <ul>
                                    <li><a href="contact_us_01.html">اتصل بنا 1</a>
                                    </li>
                                    <li><a href="contact_us_02.html">اتصل بنا 2</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="#">مظهر كلاسيكي</a>
                                        <ul>
                                            <li><a href="blog_classic_right_sidebar.html">الشريط الجانبي عن اليمين</a>
                                            </li>
                                            <li><a href="blog_classic_left_sidebar.html">الشريط الجانبي عن اليسار</a>
                                            </li>
                                            <li><a href="blog_classic_fullwidth.html">العرض الكامل</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#">عرض الشبكة</a>
                                        <ul>
                                            <li><a href="blog_grid_3col.html">3 أعمدة</a>
                                            </li>
                                            <li><a href="blog_grid_2col.html">2 أعمدة</a>
                                            </li>
                                            <li><a href="blog_grid_right_sidebar.html">الشريط الجانبي عن اليمين</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        <ul>
                                            <li><a href="blog_list_right_sidebar.html">الشريط الجانبي عن اليمين</a>
                                            </li>
                                            <li><a href="blog_list_left_sidebar.html">الشريط الجانبي عن اليسار</a>
                                            </li>
                                            <li><a href="blog_list_fullwidth.html">العرض الكامل</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#">صفحة التدوينة</a>
                                        <ul>
                                            <li><a href="blog_single_standard.html">تدوينة عادية</a>
                                            </li>
                                            <li><a href="blog_single_gallery.html">تدوينة البوم الصور</a>
                                            </li>
                                            <li><a href="blog_single_youtube.html">تدوينة فيديو يوتيوب</a>
                                            </li>
                                            <li><a href="blog_single_vimeo.html">تدوينة فيديو Vimeo</a>
                                            </li>
                                            <li><a href="blog_single_map.html">تدوينة خرائط جوجل</a>
                                            </li>
                                            <li><a href="blog_single_quote.html">تدوينة الاقتباس</a>
                                            </li>
                                            <li><a href="blog_single_audio.html">تدوينة صوتية</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="signin.html">تسجيل الدخول</a>
                                    </li>
                                    <li><a href="signup.html">حساب جديد</a>
                                    </li>
                                    <li><a href="404.html">خطأ 404</a>
                                    </li>
                                    <li><a href="faq.html">أسئلة وأجوبة</a>
                                    </li>
                                    <li><a href="cart.html">سلة التسوق</a>
                                    </li>
                                    <li>
                                        <a href="checkout_method.html">الدفع</a>
                                        <ul>
                                            <li><a href="checkout_method.html">طريقة الدفع</a>
                                            </li>
                                            <li><a href="checkout_billing.html">معلومات الفواتير</a>
                                            </li>
                                            <li><a href="checkout_payment.html">معلومات الدفع</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#">صفحات العروض</a>
                                        <ul>
                                            <li><a href="deals_grid.html">عرض الشبكة</a>
                                            </li>
                                            <li><a href="deals_list.html">عرض القائمة</a>
                                            </li>
                                            <li><a href="deal_single.html">الصفقة الواحدة</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#">صفحات الكوبونات</a>
                                        <ul>
                                            <li><a href="coupons_grid.html">عرض الشبكة</a>
                                            </li>
                                            <li><a href="coupons_grid_sidebar.html">الشبكة مع الشريط الجانبي</a>
                                            </li>
                                            <li><a href="coupons_list.html">عرض القائمة</a>
                                    ...
                                    <li><a href="terms_conditions.html">سياسات الإستخدام</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <div class="nav-menu nav-menu-fixed">
                        <a href="../index.html" target="_blank">النسخة الانجليزية<i class="fa fa-long-arrow-left mr-10"></i></a>
                    </div>
                </nav>
            </div>
        </div>
            ...
            <div class="container">
                    ...
                    <div class="row row-rl-10">
                            ...
                            <div class="item panel prl-15 ptb-20">
                                <div class="row row-rl-5 row-xs-cell">
                                    <div class="col-xs-4 valign-middle">
                                        <img class="pl-10" src="assets\images\icons\tablet.png" alt="">
                                    </div>
                                    <div class="col-xs-8">
                        ...
                        <div class="col-md-4">
                            <div class="item panel prl-15 ptb-20">
                                <div class="row row-rl-5 row-xs-cell">
                                    <div class="col-xs-4 valign-middle">
                                        <img class="pl-10" src="assets\images\icons\online-shop-6.png" alt="">
                                    </div>
                                    <div class="col-xs-8">
                        ...
                        <div class="col-md-4">
                            <div class="item panel prl-15 ptb-20">
                                <div class="row row-rl-5 row-xs-cell">
                                    <div class="col-xs-4 valign-middle">
                                        <img class="pl-10" src="assets\images\icons\money.png" alt="">
                                    </div>
                                    <div class="col-xs-8">
                ...
                <section class="section latest-deals-area ptb-30">
                    <header class="panel ptb-15 prl-20 pos-r mb-30">
                        ...
                        <a class="btn btn-o btn-xs pos-a left-10 pos-tb-center">عرض الكل</a>
                    </header>
                    <div class="row row-masnory row-tb-20">
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <span class="t-uppercase" data-countdown="2019/09/01 01:30:00"></span>
                                    ...
                                    <div class="deal-store-logo">
                                        <img src="assets\images\brands\brand_01.jpeg" alt="">
                                    </div>
                                </figure>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <span class="t-uppercase" data-countdown="2020/10/10 12:25:10"></span>
                                    ...
                                    <div class="deal-store-logo">
                                        <img src="assets\images\brands\brand_02.jpeg" alt="">
                                    </div>
                                </figure>
                                <div class="bg-white pt-20 pr-20 pl-15">
                                    <div class="pl-md-10">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <span class="t-uppercase" data-countdown="2020/10/10 12:25:10"></span>
                                    ...
                                    <div class="deal-store-logo">
                                        <img src="assets\images\brands\brand_03.jpeg" alt="">
                                    </div>
                                </figure>
                                <div class="bg-white pt-20 pr-20 pl-15">
                                    <div class="pl-md-10">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <span class="t-uppercase" data-countdown="2018/01/02 10:35:23"></span>
                                    ...
                                    <div class="deal-store-logo">
                                        <img src="assets\images\brands\brand_04.jpeg" alt="">
                                    </div>
                                </figure>
                                <div class="bg-white pt-20 pr-20 pl-15">
                                    <div class="pl-md-10">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <span class="t-uppercase" data-countdown="2021/12/03 03:15:00"></span>
                                    ...
                                    <div class="deal-store-logo">
                                        <img src="assets\images\brands\brand_05.jpeg" alt="">
                                    </div>
                                </figure>
                                <div class="bg-white pt-20 pr-20 pl-15">
                                    <div class="pl-md-10">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <span class="t-uppercase" data-countdown="2019/10/10 12:00:00"></span>
                                    ...
                                    <div class="deal-store-logo">
                                        <img src="assets\images\brands\brand_06.jpeg" alt="">
                                    </div>
                                </figure>
                                <div class="bg-white pt-20 pr-20 pl-15">
                                    <div class="pl-md-10">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="assets\images\coupons\coupon_01.jpeg" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="assets\images\coupons\coupon_02.jpeg" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="assets\images\coupons\coupon_03.jpeg" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="assets\images\coupons\coupon_04.jpeg" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="assets\images\coupons\coupon_05.jpeg" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="assets\images\coupons\coupon_06.jpeg" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                ...
                <section class="section stores-area stores-area-v1 ptb-30">
                    <header class="panel ptb-15 prl-20 pos-r mb-30">
                        ...
                        <a href="stores_01.html" class="btn btn-o btn-xs pos-a left-10 pos-tb-center">عرض الكل</a>
                    </header>
                    <div class="popular-stores-slider owl-slider" data-loop="true" data-autoplay="true" data-smart-speed="1000" data-autoplay-timeout="10000" data-margin="20" data-items="2" data-xxs-items="2" data-xs-items="2" data-sm-items="3" data-md-items="5" data-lg-items="6">
                        ...
                        <div class="store-item t-center">
                            <a href="store_single_01.html" class="panel is-block">
                                <div class="embed-responsive embed-responsive-4by3">
                                    <div class="store-logo">
                                        <img src="assets\images\brands\brand_07.jpeg" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="store-item t-center">
                            <a href="store_single_01.html" class="panel is-block">
                                <div class="embed-responsive embed-responsive-4by3">
                                    <div class="store-logo">
                                        <img src="assets\images\brands\brand_08.jpeg" alt="">
                                    </div>
                                </div>
                ...
                <section class="section latest-news-area blog-area blog-grid blog-3-col ptb-30">
                    <header class="panel ptb-15 prl-20 pos-r mb-30">
                        ...
                        <a href="blog_classic_right_sidebar.html" class="btn btn-o btn-xs pos-a left-10 pos-tb-center">عرض الكل</a>
                    </header>
                    <div class="row row-tb-20">
                        <!-- Blog Post -->
            ...
            <div class="row row-tb-20">
                    ...
                    <div class="row row-tb-20">
                        ...
                        <div class="footer-col col-sm-6">
                            <div class="footer-top-twitter">
                                <h2 class="color-lighter">تابعنا في تويتر</h2>
                                <ul class="twitter-list">
                                    <li class="single-twitter">
                                        <p class="color-light"><i class="ico fa fa-twitter"></i><a href="#"> تويتر :</a> خلافاَ للإعتقاد السائد فإن لوريم إيبسوم ليس نصاَ عشوائياً، بل إن له جذور في الأدب اللاتيني الكلاسيكي منذ العام 45 قبل الميلاد.</p>
                                    </li>
                                    <li class="single-twitter">
                                        <p class="color-light"><i class="ico fa fa-twitter"></i><a href="#"> تويتر :</a> خلافاَ للإعتقاد السائد فإن لوريم إيبسوم ليس نصاَ عشوائياً، بل إن له جذور في الأدب اللاتيني الكلاسيكي منذ العام 45 قبل الميلاد.</p>
                                    </li>
                            ...
                            <div class="footer-top-instagram instagram-widget">
                                ...
                                <div class="row row-tb-5 row-rl-5">
                                    <div class="instagram-widget__item col-xs-4">
                                        <img src="assets\images\instagram\instagram_01.jpeg" alt="">
                                    </div>
                                    <div class="instagram-widget__item col-xs-4">
                                        <img src="assets\images\instagram\instagram_02.jpeg" alt="">
                                    </div>
                                    <div class="instagram-widget__item col-xs-4">
                                        <img src="assets\images\instagram\instagram_03.jpeg" alt="">
                                    </div>
                                    <div class="instagram-widget__item col-xs-4">
                                        <img src="assets\images\instagram\instagram_04.jpeg" alt="">
                                    </div>
                                    <div class="instagram-widget__item col-xs-4">
                                        <img src="assets\images\instagram\instagram_05.jpeg" alt="">
                                    </div>
                                    <div class="instagram-widget__item col-xs-4">
                                        <img src="assets\images\instagram\instagram_06.jpeg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xs-12">
                    <div class="payment-methods t-center">
                        <span><img src="assets\images\icons\payment\paypal.jpeg" alt=""></span>
                        <span><img src="assets\images\icons\payment\visa.jpeg" alt=""></span>
                        <span><img src="assets\images\icons\payment\mastercard.jpeg" alt=""></span>
                        <span><img src="assets\images\icons\payment\discover.jpeg" alt=""></span>
                        <span><img src="assets\images\icons\payment\american.jpeg" alt=""></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer id="mainFooter" class="main-footer">
        <div class="container">
            <div class="row">
                <p>حقوق التأليف والنشر © 2017. جميع الحقوق محفوظة.</p>
            </div>
        </div>
    </footer>
    <!-- –––––––––––––––[ END FOOTER ]––––––––––––––– -->
